...
- Target book scale (~80 pages) for the first proof of concept.
...
- Consider whether the book benefits from an epigraph or brief framing device (a single line before chapter one that establishes tone without explaining plot).
